...
* **Bước 3: Thực thi mã qua giao thức ms-msdt.** File HTML chứa mã JavaScript sẽ kích hoạt giao thức 'ms-msdt'. Giao thức này gọi công cụ MSDT và lợi dụng một tham số có tên là 'IT\_BrowseForFile' để tiêm các dòng lệnh PowerShell độc hại vào hệ thống.
